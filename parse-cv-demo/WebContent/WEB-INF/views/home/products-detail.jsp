...
<div class="well well-small">
	...
	<div class="row-fluid">
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src="<c:url value="/resources/assets/img/${productDto.image }"></c:url>" alt="" style="width:100%"></a>
                  </div>
                </div>
			...
			<div class="span7">
				...
				<form class="form-horizontal qtyFrm" method="get" action="<c:url value="/Addcart/${productDto.id}"></c:url>">
				  <div class="control-group">
					<label class="control-label"><span><p><fmt:formatNumber type="number"  groupingUsed="true" value="${productDto.price}" />₫</p></span></label>
					<div class="controls">
